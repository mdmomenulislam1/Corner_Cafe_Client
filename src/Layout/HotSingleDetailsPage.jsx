...
const HotSingleDetailsPage = () => {

  const [hotFoodItems, setHotFoodItems] = useState([]);
  // console.log(hotFoodItems)
  const { _id, foodName, foodImage, foodQuantity, foodType, foodMakerName, foodMakerEmail, foodOrigin, foodPrice, foodDescription } = hotFoodItems || {}
...
export default HotSingleDetailsPage;