...
const HomePage = () => {
  ...
  return (
    <div className="mx-5 md:mx-8 lg:mx-12">
      <Banner />
      <h1 className=" p-5 text-4xl font-bold text-right border-r-8 text-yellow-600 border-b-8 rounded-2xl border-yellow-600 mt-8 md:mt-12 lg:mt-16 ">Hot Items</h1>
