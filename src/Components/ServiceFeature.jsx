  ...
  return (
    <section className="grid lg:grid-cols-2 gap-4 my-8 mb-20">
            <div  className="grid grid-cols-1 gap-4 md:gap-8 lg:gap-12">
                <div data-aos="flip-down" className=" gap-2 md:gap-5 lg:gap-8 flex justify-between items-center shadow-2xl rounded-2xl">
                ...
                <div data-aos="flip-right" className=" gap-2 md:gap-5 lg:gap-8 flex justify-between items-center shadow-2xl  rounded-2xl">
                    <div className="h-full w-full">
                ...
                <div data-aos="flip-left" className=" gap-2 md:gap-5 lg:gap-8 flex justify-between items-center shadow-2xl  rounded-2xl">
                    <div className="h-full w-full">
