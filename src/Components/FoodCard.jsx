...
const FoodCard = ({ food }) => {
  ...
  return (
    ...
    <div data-aos="flip-right" key={food._id} className="flex justify-between items-center shadow-2xl gap-2 md:gap-4 lg:gap-5  h-[250px] bg-white text-yellow-800 rounded-2xl ">
