...
const Navbar = () => {
  ...
  const links = <div className="flex flex-col justify-center items-center md:flex-row gap-5">
    ...
    <li><NavLink to="/allFoods" className="px-5 py-1 lg:py-2 font-bold rounded-full bg-red-900 text-white">All Foods</NavLink></li>
    <li><NavLink to="/blogs" className="px-5 py-1 lg:py-2 font-bold rounded-full bg-red-900 text-white">Blogs</NavLink></li>
    {
      user ?
  ...
  return (
    <div className="flex justify-between h-[150px] items-center bg-gray-200 shadow-lg shadow-yellow-100 lg:px-16 lg:py-5">
